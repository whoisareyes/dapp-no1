...
contract('Token', ([deployer, receiver, exchange]) => {
    ...
    describe('deployment', () => {
        ...
        it('tracks the total supply', async() => {
            ...
            results.toString().should.equal(totalSupply.toString())
        })

        it('assigns the total supply to the deployer', async() => {
            const results = await token.balanceOf(deployer)
            results.toString().should.equal(totalSupply.toString())
        })
    })
    ...
    describe('approving tokens', () => {
        ...
        describe('success', () => {
            it('allocates an allowance for delegated taken spending on exhange', async () => {
        ...
        describe('failure', () => {
            it('rejects invaluid spender', async () => {
        ...
        describe('delegated token transfers', () => {
            ...
            describe('success', async ()=> {
                ...
                it('resets the allowance', async () => {
                    const allownace = await token.allowance(deployer, exchange)
                    allownace.toString().should.equal('0')
                })
