    ...
    describe('withdrawing tokens', () => {
        ...
        describe('order actions', async () => {
            ...
            describe('filling orders', async () => {
                ...
                describe('success', async () => {
                    ...
                    it('executes the trade & charges fee', async () => {
                        ...
                        it('emits a trade event', async () => {
                            ...
                            event.id.toString().should.equal('1', 'id is correct')
                            event.user.should.equal(user1, 'user is correct')
                            event.tokenGet.should.equal(token.addressm, 'tokenGet is correct')
                            event.amountGet.toString().should.equal(tokens(1).toString(), 'amountGet is correct')
                            event.tokenGive.should.equal(ETHER_ADDRESS, 'tokenGive is correct')
                            event.amountGive.toString().should.equal(ether(1).toString(), 'amountGive is correct')
                ...
                describe('failure', async () => {
                    it('rejects invalud order ids', async () => {
                        const invaliudOrderId = 99999
                        await exchange.fillOrder(invaliudOrderId, {from: user2}).should.be.rejectedWith(EVM_REVERT)
                    })
